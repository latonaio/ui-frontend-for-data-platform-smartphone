...
import { updates } from '@/api/deliveryDocument/function-actual-goods-receipt-posting';
...
export const DeliveryDocumentFunctionActualGoodsReceiptPosting = ({
                                                                  className,
                                                                  deliveryDocument,
    ...
    <Detail className={clsx(
      ...
      <ProductDetailSection>
        <div className={`${isCreating ? 'hidden' : ''}`}>
          <div className={'text-center mb-3'}>入出荷更新(実際入荷日付時刻更新)</div>
          <div className={'mb-1'}>
            <div>入出荷の更新を行います。</div>
                        ...
                        async () => {
                          ...
                          try {
                            const response = await updates({
                              ...
                              accepter: [],
                              api_type: 'updates',
                            }, 'function-actual-goods-receipt-posting');
