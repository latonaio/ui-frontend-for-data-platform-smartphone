...
import { DeliveryDocumentFunctionActualGoodsIssuePosting as Content } from '@/components/Content';
import {
  AuthedUser,
} from '@/constants';
...
const DeliveryDocumentFunctionActualGoodsIssuePosting: React.FC<PageProps> = (data) => {
...
export default DeliveryDocumentFunctionActualGoodsIssuePosting;
